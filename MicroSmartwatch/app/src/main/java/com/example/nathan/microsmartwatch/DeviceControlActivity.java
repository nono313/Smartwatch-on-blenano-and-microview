...
public class DeviceControlActivity extends Activity{
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            Log.i(TAG, "Connection to the device");
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                Log.i(TAG, "Characteristic found : " + uuid +" : " + gattCharacteristic.getProperties());

                if((gattCharacteristic.getProperties() & BluetoothGattCharacteristic.PROPERTY_WRITE) > 0) {
                    Log.i(TAG, "This is a write enables characteristic");
                }
                if(gattCharacteristic.getUuid().equals(UUID.fromString("0000a002-0000-1000-8000-00805f9b34fb"))) {
                    Log.i(TAG, "Custom characteristic found !");
                    /*
                    gattCharacteristic.setValue("Test " + new Random().nextInt(100));
                    mBluetoothLeService.writeCharacteristic(gattCharacteristic);
                    //*/

                    if(smsReceiver == null) {

                        mBluetoothLeService.setWatchCharacteristic(gattCharacteristic);

                        smsReceiver = new SMSReceiver(mBluetoothLeService, gattCharacteristic);
